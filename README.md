...
**1.** Start by making a fork the [**Netflix-Clone**](https://github.com/Pradhyu17/Netflix-clone) repository.
...
```bash
git remote add upstream https://github.com/Pradhyu17/Netflix-clone.git
```
